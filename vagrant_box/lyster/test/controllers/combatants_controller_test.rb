...
class CombatantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create combatant" do
    assert_difference('Combatant.count') do
      post combatants_url, params: { combatant: { tournemant_id: @combatant.tournemant_id, user_id: @combatant.user_id } }
    end
  ...
  test "should update combatant" do
    patch combatant_url(@combatant), params: { combatant: { tournemant_id: @combatant.tournemant_id, user_id: @combatant.user_id } }
