...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { challenger_id: @point.challenger_id, challenger_score: @point.challenger_score, contender_id: @point.contender_id, contender_score: @point.contender_score } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { challenger_id: @point.challenger_id, challenger_score: @point.challenger_score, contender_id: @point.contender_id, contender_score: @point.contender_score } }
